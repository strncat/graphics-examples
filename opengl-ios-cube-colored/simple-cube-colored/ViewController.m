...
- (void)glkView:(GLKView *)view drawInRect:(CGRect)rect {
    // the following two lines are explained here
    //  store the depth (i.e. “Z”) component of each fragment in a buffer, and each and
    // every time you want to write a fragment, you first check if you should (i.e the new
    //  fragment is closer than the previous one).
    // http://www.opengl-tutorial.org/beginners-tutorials/tutorial-4-a-colored-cube/
